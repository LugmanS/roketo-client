...
const Inspect = () => {
    ...
    return (
        <div className="w-full min-h-screen bg-neutral-950 bg-opacity-80">
            <Navbar />
            <div className="w-full h-full max-w-5xl mx-auto flex flex-col items-start">
                <div>
                    ...
                    {collectionSlug && <FeatureCards collectionSlug={collectionSlug} page="inspect" />}
                </div>
                <Footer />
            </div>
        </div>
